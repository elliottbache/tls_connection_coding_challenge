...
Defaults:
- Expected location: `src/tlscc/_bin/pow_challenge` (override with `--pow-binary`)
...
If you change the binary interface/output format, update tlscc.client.handle_pow_cpp(...) and the unit tests
