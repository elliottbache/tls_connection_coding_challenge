...
TEST(RunPow, NormalAuthNormalDifficulty_Success)
{
    ...
    int difficulty = 4;
    PowResult result = run_pow(token, difficulty);
...
std::array<unsigned char, 20> sha256(std::span<const unsigned char> data)
{
