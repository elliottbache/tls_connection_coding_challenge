...
class TestHandlePowCpp:
    def test_handle_pow_cpp_success(self, token, difficulty, threads, suffix, pow_hash, path_to_pow_benchmark, monkeypatch, readout):
    ...
    def test_handle_pow_cpp_non_str_token(self, token, difficulty, threads, path_to_pow_benchmark, readout):
        wrong_token = 5.3
    ...
    def test_handle_pow_cpp_non_int_difficulty(self, token, difficulty, threads, path_to_pow_benchmark, readout):
    ...
    def test_handle_pow_cpp_no_executable(self, token, difficulty, threads, path_to_pow_benchmark, readout):
    ...
    def test_handle_pow_cpp_error(self, token, difficulty, threads, suffix, pow_hash, path_to_pow_benchmark, monkeypatch, readout):
        def fake_subprocess_run(*a, **k):
    ...
    def test_handle_pow_cpp_no_result(self, token, difficulty, threads, suffix, pow_hash, path_to_pow_benchmark, monkeypatch, readout):
        def fake_subprocess_run(*a, **k):
...
class TestDefineResponse:
    def test_define_response_success_helo(self, token, valid_messages, path_to_pow_benchmark, threads, readout):
    ...
    def test_define_response_success_end(self, token, valid_messages, path_to_pow_benchmark, threads, readout):
        import queue
    ...
    def test_define_response_success_error(self, token, valid_messages, path_to_pow_benchmark, threads, readout):
        import queue
    ...
    def test_define_response_success(self, token, random_string, valid_messages, path_to_pow_benchmark, threads, readout):
        import queue
        q = queue.Queue()
        responses = {"MAILNUM": "2"}
        ...
        out = readout()
        assert "Extra arguments = " + args[1] + "\nAuthentification data = " +  token in out

    def test_define_response_success_pow(self, token, difficulty, random_string, suffix, valid_messages, path_to_pow_benchmark, threads, readout, monkeypatch):
        import queue
        q = queue.Queue()
        responses = {"MAILNUM": "2"}
    ...
    def test_define_response_success_invalid(self, token, valid_messages, path_to_pow_benchmark, threads):
        import queue
    ...
    def test_define_response_result_no_newline(self, token, difficulty, random_string, suffix, valid_messages, path_to_pow_benchmark, threads, readout, monkeypatch):
        import queue
        q = queue.Queue()
        responses = {"MAILNUM": "2"}
        args = ["WORK", token, difficulty]
